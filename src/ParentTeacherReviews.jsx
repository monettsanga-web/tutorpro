    ...
    <div className="portal-view">
      ...
      {totalReviews > 0 && (
        <p className="ptr-footnote">
          ...
          or more that include a comment may appear publicly on the TutorPro website, shown with your
          child's first name only. Contact us any time if you would like a review removed.
        </p>
      )}
    </div>
  )
