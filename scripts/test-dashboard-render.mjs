...
try {
  ...
  if (!adminHtml.includes('TutorPro Online English command centre')) throw new Error('Administrator dashboard failed to render.')
  ...
  if (!teacherClassroomHtml.includes('TutorPro Online English Classroom')) throw new Error('Teacher classroom prejoin view failed to render.')
  if (!studentClassroomHtml.includes('TutorPro Online English Classroom')) throw new Error('Student classroom prejoin view failed to render.')
