...
try {
  ...
  if (!teacherInterviewHtml.includes('TutorPro English Hiring Assistant') || !teacherInterviewHtml.includes('Required first-round interview') || !teacherInterviewHtml.includes('Start AI interview') || !teacherInterviewHtml.includes('tutorpro-ai-interviewer.webp') || !teacherInterviewHtml.includes('AI interviewer · Online')) throw new Error('Required AI teacher interview and realistic interviewer portrait failed to render.')
