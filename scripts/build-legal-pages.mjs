/**
 * Generates the static trust and legal pages for TutorPro Online English.
 *
 ...
 *
 * NOTE ON ACCURACY: TutorPro Online English operates as a sole proprietorship based
  ...
  <body>
    ...
    <footer>
      <div class="container">
        ...
        <p>© ${new Date().getFullYear()} TutorPro Online English. Online English classes for children and teenagers worldwide.</p>
      </div>
    </footer>
  </body>
</html>
...
const PAGES = [
  {
    ...
    title: 'Privacy Policy — TutorPro Online English',
  ...
  {
    slug: 'terms.html',
    title: 'Terms of Service — TutorPro Online English',
    description: 'The terms that apply when you book and attend online English lessons with TutorPro Online English, including scheduling, conduct and payment terms.',
    ...
    body: `
      ...
      <p>Courseware, worksheets and lesson materials provided by TutorPro Online English are for your child's personal learning use. Please do not redistribute or resell them.</p>
...

  {
    ...
    title: 'Refund Policy — TutorPro Online English',
    description: 'Clear refund and lesson credit terms for TutorPro Online English, including the free trial, unused credits, technical failures and how to request a refund.',
    heading: 'Refund Policy',
    body: `
      <p>We want families to feel safe trying TutorPro Online English. This page sets out exactly when a refund or lesson credit applies. It is written to be read before you pay, not after.</p>
  ...
  {
    slug: 'about.html',
    title: 'About TutorPro Online English — Who We Are',
    description: 'TutorPro Online English provides one-to-one online English lessons for children and teenagers, with Cambridge and Oxford aligned courseware and vetted teachers.',
    heading: 'About TutorPro Online English',
    body: `
      <p>TutorPro Online English is an online English school for children and teenagers. Every lesson is one-to-one, so your child speaks for the whole class instead of waiting their turn in a group.</p>
      ...
      <div class="card">
        <h3>We will never:</h3>
        <ul>
          <li><strong>Charge a teacher any fee.</strong> No training fee, no registration fee, no deposit, no equipment payment. Not ever, for any reason.</li>
          <li><strong>Recruit through Telegram.</strong> We do not use Telegram at all.</li>
          <li><strong>Ask you to complete paid "tasks", top up a wallet, or move money on our behalf.</strong></li>
          <li><strong>Ask for your bank password, OTP codes, or a copy of your card.</strong></li>
        </ul>
      </div>
      <div class="card">
        <h3>How real applications work</h3>
        <p>Every genuine teacher application goes through the <strong>Teacher portal on this website</strong>. It includes a structured application form and a recorded teaching interview. We review qualifications and teaching experience before approving anyone to teach.</p>
        <p>If somebody contacted you about teaching for TutorPro Online English through Telegram, or asked you for money at any stage, <strong>it was not us</strong>. Please report it to the platform you were contacted on, and feel free to tell us so we can warn others.</p>
      </div>

      <h2>How to verify us</h2>
      <ul>
        <li>Our only website is <a href="https://www.tutorpro.site/">www.tutorpro.site</a>. We have no other domain.</li>
        <li>Our official Facebook page is <a href="${CONTACT.facebook}" target="_blank" rel="noopener">facebook.com/tutorproenglish</a>, where parents have left public recommendations.</li>
        <li>Our pricing is published openly on our <a href="/pricing.html">pricing page</a> — we do not hide costs behind a private chat.</li>
        <li>Our <a href="/refund-policy.html">refund policy</a>, <a href="/terms.html">terms</a> and <a href="/privacy-policy.html">privacy policy</a> are all published in full.</li>
        <li>Payments from parents are processed by <strong>PayPal</strong>. We never ask a family to send money to a personal account.</li>
      </ul>
    ...
    schema: {
      ...
      '@type': 'AboutPage',
      name: 'About TutorPro Online English',
      url: `${SITE}/about.html`,
      mainEntity: {
...

  {
    ...
    body: `
      ...
      <div class="card">
        <h3>Teachers</h3>
        <p>Interested in teaching with TutorPro Online English? Apply through the teacher registration on our <a href="/">homepage</a>. Applications include a short recorded teaching interview.</p>
      </div>
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'ContactPage',
      name: 'Contact TutorPro Online English',
