...
-- Account-mode support chat: one open support conversation per logged-in user.
-- This prevents duplicate support threads when parents/teachers open the chat repeatedly or from multiple devices.
